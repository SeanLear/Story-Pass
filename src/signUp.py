...
class SignUp:
    ...
    def createWidgets(self):
        ...
        username = tk.Entry(username_frame, width = 50)
        ...
        submit_bttn = tk.Button(bttn_frame, text = "Submit Account", command = lambda: self.submit())
        submit_bttn.pack(side=tk.LEFT, padx = 10, pady = 20)
